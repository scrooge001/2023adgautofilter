...
async def next_page(bot, query):
    ...
    if int(req) not in [query.from_user.id, 0]:
        return await query.answer("scrooge010", show_alert=True)
    try:
        offset = int(offset)
    except:
        offset = 0
...
async def advantage_spoll_choker(bot, query):
    ...
    if k == False:
        ...
        if files:
            ...
            k = await query.message.edit('Sorry, This Movie or Tv Series Not Found In My DataBase☹️. Please Inform Our Admins👇 \n 🕵️ <a href=https://t.me/adgmovies>@admin</a> 🕵️‍♂')
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    return await query.answer('👨‍💻ADG MOVIES👩‍💻')
            else:
    ...
    if query.data.startswith("file"):
        ...
        try:
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                ...
                await query.answer('Check PM, Film Detective sent files in PM', show_alert=True)
        except UserIsBlocked:
            await query.answer('You Are Blocked Me. Please Unblock to use me !', show_alert=True)
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🤖 ADG MOVIES 🤖', url='https://t.me/adgmovies')
            ],[
            InlineKeyboardButton('🔰 FILM GROUP 🔰', url='https://t.me/adgmovies'),
            InlineKeyboardButton('♨️ MOVIES ♨️', url='https://t.me/asiandramagroup1')
            ],[
            InlineKeyboardButton('😇 MORE 😇', callback_data='help'),
            InlineKeyboardButton('📛 ABOUT 📛', callback_data='about')
            ],[
            InlineKeyboardButton('🍭 ADG MOVIES 🍭', url='https://t.me/scrooge010')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('📣 UPDATES 📣', url='https://t.me/adgmovies'),
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⏹️ BUTTONS ⏺️', callback_data='button')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
